...
export const SCHEDULE_LATE_1010 = [
  ...
  { id: "08", label: "Period 08", start: [14, 1], end: [14, 29], include: true },
  { id: "09", label: "Period 09", start: [14, 34], end: [15, 2], include: true },
];

// Exam Schedules
export const SCHEDULE_EXAM_DEC17 = [
  { id: "EX", label: "Exam: Period 2", start: [8, 10], end: [9, 30], include: true },
  { id: "EX", label: "Exam: Period 3", start: [9, 40], end: [11, 0], include: true },
  { id: "EX", label: "Exam: Period 6", start: [11, 10], end: [12, 30], include: true },
];

export const SCHEDULE_EXAM_DEC18 = [
  { id: "EX", label: "Exam: Period 4", start: [8, 10], end: [9, 30], include: true },
  { id: "EX", label: "Exam: Period 9", start: [9, 40], end: [11, 0], include: true },
  { id: "EX", label: "Exam: Period 8", start: [11, 10], end: [12, 30], include: true },
];

export const SCHEDULE_EXAM_DEC19 = [
  { id: "EX", label: "Exam: Period 7", start: [8, 10], end: [9, 30], include: true },
  { id: "EX", label: "Exam: Period 1", start: [9, 40], end: [11, 0], include: true },
  { id: "EX", label: "Exam: Period 5", start: [11, 10], end: [12, 30], include: true },
];

// PM Assembly Schedule
export const SCHEDULE_PM_ASSEMBLY = [
  { id: "01", label: "Period 01", start: [8, 10], end: [8, 45], include: true },
  { id: "02", label: "Period 02", start: [8, 50], end: [9, 25], include: true },
  { id: "03", label: "Period 03", start: [9, 30], end: [10, 5], include: true },
  { id: "04", label: "Period 04", start: [10, 10], end: [10, 45], include: true },
  { id: "05", label: "Period 05", start: [10, 50], end: [11, 25], include: true },
  { id: "06", label: "Period 06", start: [11, 30], end: [12, 5], include: true },
  { id: "07", label: "Period 07", start: [12, 10], end: [12, 45], include: true },
  { id: "08", label: "Period 08", start: [12, 50], end: [13, 25], include: true },
  { id: "09", label: "Period 09", start: [13, 30], end: [14, 5], include: true },
  { id: "HR", label: "Homeroom", start: [14, 10], end: [14, 23], include: false },
  { id: "ASM", label: "Assembly*", start: [14, 28], end: [15, 23], include: true },
];
...
export const SPECIAL_DATES = {
  '2025-12-12': 'PM_ASSEMBLY',
  '2025-12-17': 'EXAM_DEC17',
  '2025-12-18': 'EXAM_DEC18',
  '2025-12-19': 'EXAM_DEC19'
};
...
export const FINAL_EXAMS = [
  "2025-12-17",  // Wednesday, December 17, 2025
